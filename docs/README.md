...
| `MUSIC_SPEC.md` | **The Part D build contract** (music app: knowledge base + player + resolver; ALL FIVE PHASES BUILT 2026-08-05 — statuses in its header/D9; on-glass gates are Adam's). |
...
| `EARBUD_SPEC.md` | The Part C earbud-lane spec — **design REJECTED 2026-08-04** (its post-mortem is MUSIC_SPEC's required reading; the lane's code was REMOVED by Phase B, 2026-08-05 — TTS/Companion pieces stay dormant on disk). |
